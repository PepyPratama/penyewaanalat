            ...
            <div class="col-12">
                ...
                <?php if (empty($alat)): ?>
                    <div class="alert alert-danger text-white">
                        Tidak ada data alat yang rusak.
                    </div>
                <?php else: ?>
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        ...
                        <div>
                            <a href="<?= base_url('owner/alat_rusak_excel'); ?>" class="btn btn-success text-white">Excel</a>
                            <a href="<?= base_url('owner/alat_rusak_pdf'); ?>" target="_blank" class="btn btn-danger text-white">PDF</a>
                        </div>
                    </div>
                    <div class="card-body">
