                ...
                <div class="modal-body">
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-6 waktuPengembalian" style="display: none;">
                            ...
                            <select id="waktu_pengembalian" name="waktu_pengembalian" class="form-control waktu_pengembalian" required>
                                <option selected disabled value="">Pilih</option>
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-6 keteranganPengembalian" style="display: none;">
                            ...
                            <select id="keterangan_pengembalian" name="keterangan_pengembalian" class="form-control keterangan_pengembalian" required>
                                <option selected disabled value="">Pilih</option>
